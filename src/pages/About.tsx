    ...
    <div className="bg-zinc-950 text-white font-sans">
      ...
      <section className="relative pt-24 pb-16 md:pt-40 md:pb-24 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          >
            FORJADOS NO <br />
            <span className="text-red-600 not-italic">FOGO E SABOR.</span>
          </motion.h2>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            <div className="space-y-10">
              <h2
                id="story-title"
                className="text-5xl font-black uppercase tracking-tight leading-tight"
              >
                O Autêntico <span className="text-red-600">Pit Dog</span> de Goiânia
              </h2>

              <p className="text-gray-400 text-xl leading-relaxed">
                Nascido em 2012 no coração da{' '}
                <strong className="text-white">Leste Vila Nova</strong>, o Tri Burgers não é apenas uma hamburgueria, é um marco da cultura gastronômica goiana. Nossa missão é preservar a essência do "Pit Dog" tradicional, elevando-a com técnicas artesanais de alta gastronomia.
              </p>

              <p className="text-gray-400 text-xl leading-relaxed">
                Cada blend é moído na casa diariamente, utilizando apenas cortes selecionados. Nosso diferencial? O{' '}
                <strong className="text-white">Molho Verde Secreto</strong>, uma receita de família que se tornou a lenda entre os moradores do Setor Vila Nova e região central. Aqui, a transparência é real: da fogueira para a sua mesa.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: 'Variedade',
                desc: 'Do tradicional X-Tudo ao Gourmet de Costela, temos opções para todos os gostos e fomes.',
              },
              {
                title: 'Delivery',
                desc: 'Logística própria e eficiente para garantir que seu lanche chegue rápido e impecável.',
              },
              {
                title: 'Comunidade',
                desc: 'Valorizamos o atendimento local e a satisfação de cada cliente que nos escolhe desde 2012.',
              },
            ].map((value, idx) => (
              <div
                key={idx}
                className="p-10 bg-black border border-white/5 rounded-[2rem] hover:border-red-600/50 transition-colors"
              >
                <h3 className="text-2xl font-black text-red-600 uppercase mb-4">
                  {value.title}
                </h3>
